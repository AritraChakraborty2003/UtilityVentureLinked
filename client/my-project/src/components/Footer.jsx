    ...
    <>
      <div className="bg-black mt-10">
        <div
          ...
          style={myStyle}
        >
          <div className="w-[100vw] lg:w-[50vmin]  flex flex-col mt-2 items-center">
        ...
        <div className="text-white p-2 border-white border-t-2 flex justify-center items-center w-[96vw] ml-2 mr-2">
          @venture Linked 2024
        </div>
      </div>
    </>
