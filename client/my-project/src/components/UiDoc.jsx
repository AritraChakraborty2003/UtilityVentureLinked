...
const UiDoc = () => {
  ...
  const getPDF = (e) => {
    ...
    doc.text(`Abhishek Kr. Pandey`, 23, 385);
    doc.setFontSize(10);
    doc.text(`( Management Head )`, 23, 394);
            ...
            <div className="mt-4 lg:mt-2 formArea bg-white w-[97vw] lg:w-[90vw]  p-2  lg:pt-7 flex flex-col justify-center items-center flex-wrap rounded-2xl">
              <div className="header">
                <p className="text-[5vmin] font-bold  mt-2">
                  Please Fill the details for UI/UX documentation
                </p>
              </div>
              <form>
                    ...
                    <ul className="flex gap-y-4 flex-col">
                      ...
                      <li>
                        ...
                        <input
                          type="text"
                          className="w-11/12 bg-slate-200 p-2"
                          placeholder="Enter body of styles in 20 words..."
                      ...
                      <li>
                        ...
                        <input
                          type="text"
                          className="w-11/12 bg-slate-200 p-2"
                          placeholder="Enter point1 for styles used in 20 words..."
                      ...
                      <li>
                        ...
                        <input
                          type="text"
                          className="w-11/12 bg-slate-200 p-2"
                          placeholder="Enter point2 for styles used in 20 words..."
                      ...
                      <li>
                        ...
                        <input
                          type="text"
                          className="w-11/12 bg-slate-200 p-2"
                          placeholder="Enter point3 for styles used in 20 words..."
                          onChange={(e) => {
                      ...
                      <li>
                        ...
                        <input
                          type="text"
                          className="w-11/12 bg-slate-200 p-2"
                          placeholder="Enter point4 for styles used in 20 words..."
                          onChange={(e) => {
                      ...
                      <li>
                        ...
                        <input
                          type="text"
                          className="w-11/12 bg-slate-200 p-2"
                          placeholder="Enter point5 for styles used in 20 words..."
                          onChange={(e) => {
                    ...
                    <ul className="flex gap-y-4 flex-col">
                      ...
                      <li>
                        <input
                          type="text"
                          className="w-11/12 bg-slate-200 p-2"
                          placeholder="Enter colour theme body & design in 20 words..."
                      ...
                      <li>
                        ...
                        <input
                          type="text"
                          className="w-11/12 bg-slate-200 p-2"
                          placeholder="Enter point1 for colour theme & design in 20 words..."
                      ...
                      <li>
                        ...
                        <input
                          type="text"
                          className="w-11/12 bg-slate-200 p-2"
                          placeholder="Enter point2 for colour theme & design in 20 words..."
                      ...
                      <li>
                        ...
                        <input
                          type="text"
                          className="w-11/12 bg-slate-200 p-2"
                          placeholder="Enter point3 for colour theme & design in 20 words..."
                      ...
                      <li>
                        ...
                        <input
                          type="text"
                          className="w-11/12 bg-slate-200 p-2"
                          placeholder="Enter point4 for colour theme & design in 20 words..."
                          onChange={(e) => {
                      ...
                      <li>
                        ...
                        <input
                          type="text"
                          className="w-11/12 bg-slate-200 p-2"
                          placeholder="Enter point5 for colour theme & design in 20 words..."
                          onChange={(e) => {
